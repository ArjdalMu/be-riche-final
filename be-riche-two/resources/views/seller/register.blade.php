    ...
    <div class="flex justify-center h-screen">
            ...
            <div class="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
                <div>
                    ...
                    <p class="max-w-xl mt-3 text-gray-300">
                        Join our website and experience the best in hosting your products and receiving orders from different parts of the world.</p>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
            <div class="flex-1">
                ...
                <div class="text-center">
                    <p class="mt-3 text-gray-500 dark:text-gray-300">Create an acount and get started</p>
                </div>
