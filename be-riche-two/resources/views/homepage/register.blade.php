    ...
    <div class="flex justify-center h-screen">
        <div class="hidden bg-cover lg:block lg:w-2/3" style="background-image: url(https://images.unsplash.com/photo-1616763355603-9755a640a287?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80)">
            <div class="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
                <div>
                    <h2 class="text-4xl font-bold text-white">Be Riche</h2>
                    
                    <p class="max-w-xl mt-3 text-gray-300">
                        Join our website and enjoy the best experience in purchasing high-quality products.</p>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
            <div class="flex-1">
                <div class="text-center">
                    <h2 class="text-4xl font-bold text-center text-gray-700 dark:text-white"><img src="{{asset('upload/logo2.png')}}" class="w-20 mx-auto" alt=""></h2>
                    
                    <p class="mt-3 text-gray-500 dark:text-gray-300">Create a account and getting start</p>
                </div>
