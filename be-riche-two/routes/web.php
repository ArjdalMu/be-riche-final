...
Route::middleware('auth', 'role:seller')->group(function () {
    Route::controller(SellerController::class)->group(function () {
        ...
        Route::get('/seller-profile', 'showme')->name('show-seller');
        Route::get('seller-profile-edit','editSeller')->name('edit-seller');
        Route::post('/seller-profile-update','updateSeller')->name('update-seller');
